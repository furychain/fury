...
// source: merlin/market/odds.proto
...
func init() {
	proto.RegisterType((*Odds)(nil), "merlinnetwork.merlin.market.Odds")
}

func init() { proto.RegisterFile("merlin/market/odds.proto", fileDescriptor_cf7f1000ed50889d) }
