...
func init() {
	proto.RegisterType((*MsgAddMarket)(nil), "merlinnetwork.merlin.market.MsgAddMarket")
	proto.RegisterType((*MsgAddMarketResponse)(nil), "merlinnetwork.merlin.market.MsgAddMarketResponse")
	proto.RegisterType((*MsgResolveMarket)(nil), "merlinnetwork.merlin.market.MsgResolveMarket")
	proto.RegisterType((*MsgResolveMarketResponse)(nil), "merlinnetwork.merlin.market.MsgResolveMarketResponse")
	proto.RegisterType((*MsgUpdateMarket)(nil), "merlinnetwork.merlin.market.MsgUpdateMarket")
	proto.RegisterType((*MsgUpdateMarketResponse)(nil), "merlinnetwork.merlin.market.MsgUpdateMarketResponse")
}

func init() { proto.RegisterFile("merlin/market/tx.proto", fileDescriptor_d0e875658c4f19fd) }
...
func (c *msgClient) AddMarket(ctx context.Context, in *MsgAddMarket, opts ...grpc.CallOption) (*MsgAddMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Msg/AddMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveMarket(ctx context.Context, in *MsgResolveMarket, opts ...grpc.CallOption) (*MsgResolveMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Msg/ResolveMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarket(ctx context.Context, in *MsgUpdateMarket, opts ...grpc.CallOption) (*MsgUpdateMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Msg/UpdateMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Msg/AddMarket",
	}
...
func _Msg_ResolveMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Msg/ResolveMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Msg/UpdateMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.merlin.market.Msg",
	...
	Metadata: "merlin/market/tx.proto",
}
