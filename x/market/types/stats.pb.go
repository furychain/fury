...
// source: merlin/market/stats.proto
...
func init() {
	proto.RegisterType((*MarketStats)(nil), "merlinnetwork.merlin.market.MarketStats")
}

func init() { proto.RegisterFile("merlin/market/stats.proto", fileDescriptor_ee763120d9ee1c76) }
