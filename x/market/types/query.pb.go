...
// source: merlin/market/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "merlinnetwork.merlin.market.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "merlinnetwork.merlin.market.QueryParamsResponse")
	proto.RegisterType((*QueryMarketRequest)(nil), "merlinnetwork.merlin.market.QueryMarketRequest")
	proto.RegisterType((*QueryMarketResponse)(nil), "merlinnetwork.merlin.market.QueryMarketResponse")
	proto.RegisterType((*QueryMarketsRequest)(nil), "merlinnetwork.merlin.market.QueryMarketsRequest")
	proto.RegisterType((*QueryMarketsResponse)(nil), "merlinnetwork.merlin.market.QueryMarketsResponse")
	proto.RegisterType((*QueryMarketsByUIDsRequest)(nil), "merlinnetwork.merlin.market.QueryMarketsByUIDsRequest")
	proto.RegisterType((*QueryMarketsByUIDsResponse)(nil), "merlinnetwork.merlin.market.QueryMarketsByUIDsResponse")
}

func init() { proto.RegisterFile("merlin/market/query.proto", fileDescriptor_a0102cd07774feff) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Market(ctx context.Context, in *QueryMarketRequest, opts ...grpc.CallOption) (*QueryMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Query/Market", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Markets(ctx context.Context, in *QueryMarketsRequest, opts ...grpc.CallOption) (*QueryMarketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Query/Markets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MarketsByUIDs(ctx context.Context, in *QueryMarketsByUIDsRequest, opts ...grpc.CallOption) (*QueryMarketsByUIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.market.Query/MarketsByUIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Query/Params",
	}
...
func _Query_Market_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Query/Market",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Markets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Query/Markets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_MarketsByUIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.market.Query/MarketsByUIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.merlin.market.Query",
	...
	Metadata: "merlin/market/query.proto",
}
