...
// source: merlin/market/ticket.proto
...
type MarketAddTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,5,opt,name=status,proto3,enum=merlinnetwork.merlin.market.MarketStatus" json:"status,omitempty"`
...
type MarketUpdateTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,6,opt,name=status,proto3,enum=merlinnetwork.merlin.market.MarketStatus" json:"status,omitempty"`
}
...
type MarketResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status MarketStatus `protobuf:"varint,4,opt,name=status,proto3,enum=merlinnetwork.merlin.market.MarketStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MarketAddTicketPayload)(nil), "merlinnetwork.merlin.market.MarketAddTicketPayload")
	proto.RegisterType((*MarketUpdateTicketPayload)(nil), "merlinnetwork.merlin.market.MarketUpdateTicketPayload")
	proto.RegisterType((*MarketResolutionTicketPayload)(nil), "merlinnetwork.merlin.market.MarketResolutionTicketPayload")
}

func init() { proto.RegisterFile("merlin/market/ticket.proto", fileDescriptor_1dc46cd902954700) }
