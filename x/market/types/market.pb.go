...
// source: merlin/market/market.proto
...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.market.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterType((*Market)(nil), "merlinnetwork.merlin.market.Market")
	proto.RegisterType((*MarketBetConstraints)(nil), "merlinnetwork.merlin.market.MarketBetConstraints")
}

func init() { proto.RegisterFile("merlin/market/market.proto", fileDescriptor_935a8ad1d6bee065) }
