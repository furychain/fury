...
// source: merlin/strategicreserve/orderbook.proto
...
type OrderBook struct {
	...
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=merlinnetwork.merlin.strategicreserve.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.strategicreserve.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "merlinnetwork.merlin.strategicreserve.OrderBook")
}

func init() {
	proto.RegisterFile("merlin/strategicreserve/orderbook.proto", fileDescriptor_fd759bf8b8b48f1e)
}
