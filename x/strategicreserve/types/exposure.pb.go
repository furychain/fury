...
// source: merlin/strategicreserve/exposure.proto
...
func init() {
	proto.RegisterType((*OrderBookOddsExposure)(nil), "merlinnetwork.merlin.strategicreserve.OrderBookOddsExposure")
	proto.RegisterType((*ParticipationExposure)(nil), "merlinnetwork.merlin.strategicreserve.ParticipationExposure")
}

func init() {
	proto.RegisterFile("merlin/strategicreserve/exposure.proto", fileDescriptor_90d2f27f5a9b2729)
}
