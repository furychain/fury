...
func init() {
	proto.RegisterType((*BetStats)(nil), "merlinnetwork.merlin.bet.BetStats")
}

func init() { proto.RegisterFile("merlin/bet/stats.proto", fileDescriptor_e7bd589ff6fa2d86) }
