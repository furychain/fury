...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=merlinnetwork.merlin.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=merlinnetwork.merlin.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=merlinnetwork.merlin.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("merlinnetwork.merlin.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "merlinnetwork.merlin.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "merlinnetwork.merlin.bet.UID2ID")
	proto.RegisterType((*PendingBet)(nil), "merlinnetwork.merlin.bet.PendingBet")
	proto.RegisterType((*SettledBet)(nil), "merlinnetwork.merlin.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "merlinnetwork.merlin.bet.BetFulfillment")
}

func init() { proto.RegisterFile("merlin/bet/bet.proto", fileDescriptor_9bc076bb1a4d9f6e) }
