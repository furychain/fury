...
// source: merlin/bet/ticket.proto
...
import (
	...
	types "github.com/merlin-network/merlin/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=merlinnetwork.merlin.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "merlinnetwork.merlin.bet.BetPlacementTicketPayload")
}

func init() { proto.RegisterFile("merlin/bet/ticket.proto", fileDescriptor_cf6959e7db451613) }
