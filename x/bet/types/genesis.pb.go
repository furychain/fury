...
// source: merlin/bet/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "merlinnetwork.merlin.bet.GenesisState")
}

func init() { proto.RegisterFile("merlin/bet/genesis.proto", fileDescriptor_6c49ebc0f2678a09) }
