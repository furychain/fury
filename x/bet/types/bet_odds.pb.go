...
// source: merlin/bet/bet_odds.proto
...
func init() {
	proto.RegisterType((*BetOdds)(nil), "merlinnetwork.merlin.bet.BetOdds")
}

func init() { proto.RegisterFile("merlin/bet/bet_odds.proto", fileDescriptor_2629a03d0a23fb04) }
