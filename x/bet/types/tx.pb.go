...
func init() {
	proto.RegisterType((*MsgPlaceBet)(nil), "merlinnetwork.merlin.bet.MsgPlaceBet")
	proto.RegisterType((*MsgPlaceBetResponse)(nil), "merlinnetwork.merlin.bet.MsgPlaceBetResponse")
}

func init() { proto.RegisterFile("merlin/bet/tx.proto", fileDescriptor_38b4167f68c2a7f8) }
...
func (c *msgClient) PlaceBet(ctx context.Context, in *MsgPlaceBet, opts ...grpc.CallOption) (*MsgPlaceBetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.bet.Msg/PlaceBet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.bet.Msg/PlaceBet",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.merlin.bet.Msg",
