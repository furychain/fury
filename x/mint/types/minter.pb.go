...
// source: merlin/mint/minter.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "merlinnetwork.merlin.mint.Minter")
}

func init() { proto.RegisterFile("merlin/mint/minter.proto", fileDescriptor_d31ed0ee2430eeec) }
