...
// source: merlin/mint/phase.proto
...
func init() {
	proto.RegisterType((*Phase)(nil), "merlinnetwork.merlin.mint.Phase")
}

func init() { proto.RegisterFile("merlin/mint/phase.proto", fileDescriptor_7fc2241b526dba74) }
