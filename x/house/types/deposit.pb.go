...
// source: merlin/house/deposit.proto
...
func init() {
	proto.RegisterType((*Deposit)(nil), "merlinnetwork.merlin.house.Deposit")
}

func init() { proto.RegisterFile("merlin/house/deposit.proto", fileDescriptor_c6f2840908fc45a1) }
