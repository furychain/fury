...
// source: merlin/house/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "merlinnetwork.merlin.house.Params")
}

func init() { proto.RegisterFile("merlin/house/params.proto", fileDescriptor_632fcdf2e68e6d32) }
