...
// source: merlin/house/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "merlinnetwork.merlin.house.GenesisState")
}

func init() { proto.RegisterFile("merlin/house/genesis.proto", fileDescriptor_aa4dcd3bb98435db) }
