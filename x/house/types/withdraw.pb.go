...
// source: merlin/house/withdraw.proto
...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=merlinnetwork.merlin.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "merlinnetwork.merlin.house.Withdrawal")
}

func init() { proto.RegisterFile("merlin/house/withdraw.proto", fileDescriptor_9ca852402ebf549d) }
