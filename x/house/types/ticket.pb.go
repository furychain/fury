...
// source: merlin/house/ticket.proto
...
func init() {
	proto.RegisterType((*DepositTicketPayload)(nil), "merlinnetwork.merlin.house.DepositTicketPayload")
	proto.RegisterType((*WithdrawTicketPayload)(nil), "merlinnetwork.merlin.house.WithdrawTicketPayload")
}

func init() { proto.RegisterFile("merlin/house/ticket.proto", fileDescriptor_1f686c28436675f2) }
