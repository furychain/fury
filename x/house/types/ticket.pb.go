...
// source: fury/house/ticket.proto
...
import (
	...
	types "github.com/furychain/fury/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func init() {
	proto.RegisterType((*DepositTicketPayload)(nil), "furynetwork.fury.house.DepositTicketPayload")
	proto.RegisterType((*WithdrawTicketPayload)(nil), "furynetwork.fury.house.WithdrawTicketPayload")
}

func init() { proto.RegisterFile("fury/house/ticket.proto", fileDescriptor_1f686c28436675f2) }
