...
type QueryPublicKeysChangeProposalRequest struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=merlinnetwork.merlin.ovm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "merlinnetwork.merlin.ovm.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "merlinnetwork.merlin.ovm.QueryParamsResponse")
	proto.RegisterType((*QueryPubKeysRequest)(nil), "merlinnetwork.merlin.ovm.QueryPubKeysRequest")
	proto.RegisterType((*QueryPubKeysResponse)(nil), "merlinnetwork.merlin.ovm.QueryPubKeysResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalRequest)(nil), "merlinnetwork.merlin.ovm.QueryPublicKeysChangeProposalRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalResponse)(nil), "merlinnetwork.merlin.ovm.QueryPublicKeysChangeProposalResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalsRequest)(nil), "merlinnetwork.merlin.ovm.QueryPublicKeysChangeProposalsRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalsResponse)(nil), "merlinnetwork.merlin.ovm.QueryPublicKeysChangeProposalsResponse")
}

func init() { proto.RegisterFile("merlin/ovm/query.proto", fileDescriptor_40d67ba9adaeca00) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.ovm.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PubKeys(ctx context.Context, in *QueryPubKeysRequest, opts ...grpc.CallOption) (*QueryPubKeysResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.ovm.Query/PubKeys", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposal(ctx context.Context, in *QueryPublicKeysChangeProposalRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.ovm.Query/PublicKeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposals(ctx context.Context, in *QueryPublicKeysChangeProposalsRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlinnetwork.merlin.ovm.Query/PublicKeysChangeProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.ovm.Query/Params",
	}
...
func _Query_PubKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.ovm.Query/PubKeys",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.ovm.Query/PublicKeysChangeProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlinnetwork.merlin.ovm.Query/PublicKeysChangeProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlinnetwork.merlin.ovm.Query",
	...
	Metadata: "merlin/ovm/query.proto",
}
