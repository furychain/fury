...
type QueryPublicKeysChangeProposalRequest struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furynetwork.fury.ovm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furynetwork.fury.ovm.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furynetwork.fury.ovm.QueryParamsResponse")
	proto.RegisterType((*QueryPubKeysRequest)(nil), "furynetwork.fury.ovm.QueryPubKeysRequest")
	proto.RegisterType((*QueryPubKeysResponse)(nil), "furynetwork.fury.ovm.QueryPubKeysResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalRequest)(nil), "furynetwork.fury.ovm.QueryPublicKeysChangeProposalRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalResponse)(nil), "furynetwork.fury.ovm.QueryPublicKeysChangeProposalResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalsRequest)(nil), "furynetwork.fury.ovm.QueryPublicKeysChangeProposalsRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalsResponse)(nil), "furynetwork.fury.ovm.QueryPublicKeysChangeProposalsResponse")
}

func init() { proto.RegisterFile("fury/ovm/query.proto", fileDescriptor_40d67ba9adaeca00) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.ovm.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PubKeys(ctx context.Context, in *QueryPubKeysRequest, opts ...grpc.CallOption) (*QueryPubKeysResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.ovm.Query/PubKeys", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposal(ctx context.Context, in *QueryPublicKeysChangeProposalRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.ovm.Query/PublicKeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposals(ctx context.Context, in *QueryPublicKeysChangeProposalsRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furynetwork.fury.ovm.Query/PublicKeysChangeProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.ovm.Query/Params",
	}
...
func _Query_PubKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.ovm.Query/PubKeys",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.ovm.Query/PublicKeysChangeProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furynetwork.fury.ovm.Query/PublicKeysChangeProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furynetwork.fury.ovm.Query",
