...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furynetwork.fury.ovm.GenesisState")
}

func init() { proto.RegisterFile("fury/ovm/genesis.proto", fileDescriptor_89d2511229f4bb0b) }
