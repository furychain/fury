...
// source: merlin/ovm/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "merlinnetwork.merlin.ovm.GenesisState")
}

func init() { proto.RegisterFile("merlin/ovm/genesis.proto", fileDescriptor_89d2511229f4bb0b) }
