...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "merlinnetwork.merlin.ovm.ProposalStats")
}

func init() { proto.RegisterFile("merlin/ovm/stats.proto", fileDescriptor_2e241b25311754a9) }
