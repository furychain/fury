...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "furynetwork.fury.ovm.ProposalStats")
}

func init() { proto.RegisterFile("fury/ovm/stats.proto", fileDescriptor_2e241b25311754a9) }
