...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=furynetwork.fury.ovm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "furynetwork.fury.ovm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "furynetwork.fury.ovm.ProposalVotePayload")
}

func init() { proto.RegisterFile("fury/ovm/ticket.proto", fileDescriptor_d64e3af56c76dec2) }
