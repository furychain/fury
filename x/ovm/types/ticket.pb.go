...
// source: merlin/ovm/ticket.proto
...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=merlinnetwork.merlin.ovm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "merlinnetwork.merlin.ovm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "merlinnetwork.merlin.ovm.ProposalVotePayload")
}

func init() { proto.RegisterFile("merlin/ovm/ticket.proto", fileDescriptor_d64e3af56c76dec2) }
