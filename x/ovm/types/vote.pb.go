...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.ovm.ProposalVote", ProposalVote_name, ProposalVote_value)
	proto.RegisterType((*Vote)(nil), "merlinnetwork.merlin.ovm.Vote")
}

func init() { proto.RegisterFile("merlin/ovm/vote.proto", fileDescriptor_bbd1cf24e657c25c) }
