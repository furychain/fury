...
func init() {
	proto.RegisterEnum("furynetwork.fury.ovm.ProposalVote", ProposalVote_name, ProposalVote_value)
	proto.RegisterType((*Vote)(nil), "furynetwork.fury.ovm.Vote")
}

func init() { proto.RegisterFile("fury/ovm/vote.proto", fileDescriptor_bbd1cf24e657c25c) }
