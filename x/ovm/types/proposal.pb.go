...
// source: fury/ovm/proposal.proto
...
type PublicKeysChangeProposal struct {
	...
	Result ProposalResult `protobuf:"varint,6,opt,name=result,proto3,enum=furynetwork.fury.ovm.ProposalResult" json:"result,omitempty"`
	...
	Status ProposalStatus `protobuf:"varint,9,opt,name=status,proto3,enum=furynetwork.fury.ovm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furynetwork.fury.ovm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterEnum("furynetwork.fury.ovm.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "furynetwork.fury.ovm.PublicKeysChangeProposal")
}

func init() { proto.RegisterFile("fury/ovm/proposal.proto", fileDescriptor_e792f74ac2c59557) }
