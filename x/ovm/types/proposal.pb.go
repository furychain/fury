...
// source: merlin/ovm/proposal.proto
...
type PublicKeysChangeProposal struct {
	...
	Result ProposalResult `protobuf:"varint,6,opt,name=result,proto3,enum=merlinnetwork.merlin.ovm.ProposalResult" json:"result,omitempty"`
	...
	Status ProposalStatus `protobuf:"varint,9,opt,name=status,proto3,enum=merlinnetwork.merlin.ovm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("merlinnetwork.merlin.ovm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterEnum("merlinnetwork.merlin.ovm.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "merlinnetwork.merlin.ovm.PublicKeysChangeProposal")
}

func init() { proto.RegisterFile("merlin/ovm/proposal.proto", fileDescriptor_e792f74ac2c59557) }
