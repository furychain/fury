...
// source: merlin/ovm/key_vault.proto
...
func init() {
	proto.RegisterType((*KeyVault)(nil), "merlinnetwork.merlin.ovm.KeyVault")
}

func init() { proto.RegisterFile("merlin/ovm/key_vault.proto", fileDescriptor_58deae9100d60c6b) }
