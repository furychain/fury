...
// source: fury/ovm/key_vault.proto
...
func init() {
	proto.RegisterType((*KeyVault)(nil), "furynetwork.fury.ovm.KeyVault")
}

func init() { proto.RegisterFile("fury/ovm/key_vault.proto", fileDescriptor_58deae9100d60c6b) }
