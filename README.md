...
```shell
furyd init {{NODE_NAME}} --chain-id furychain-1
```
...
- [furychain-1](https://github.com/furychain/networks/furychain-1)

- Place the genesis file  with the genesis file of the chain.

```shell
wget https://github.com/furychain/networks/blob/master/furychain-1/genesis.json -O ~/.fury/config/genesis.json
```
...
Correct sha256 sum for furychain-1 is - 2bea72699f9c1afd6217f7e76f14f07c1fbe849d090fc37cd008a42d14d5d30c
