...
HTTPS_GIT := https://github.com/merlin-network/merlin.git
...
ifeq (secp,$(findstring secp,$(MERLIN_BUILD_OPTIONS)))
...
ifeq (badgerdb,$(findstring badgerdb,$(MERLIN_BUILD_OPTIONS)))
  ldflags += -X github.com/cosmos/cosmos-sdk/types.DBBackend=badgerdb
  BUILD_TAGS += badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(MERLIN_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/cosmos/cosmos-sdk/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(MERLIN_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
...
ifneq ($(GO_MINOR_VERSION),18)
	@echo "ERROR: Go version 1.18 is required for this version of MERLIN. Go 1.19 has changes that are believed to break consensus."
	exit 1
endif
...
protoVer=v0.8
protoImageName=merlinnetwork/merlin-proto-gen:$(protoVer)
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/MERLIN-Network/MERLIN/types"
	godoc -http=:6060
