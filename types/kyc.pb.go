...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "merlinnetwork.merlin.type.KycDataPayload")
}

func init() { proto.RegisterFile("merlin/type/kyc.proto", fileDescriptor_aefa821fa9aaec33) }
