...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "furynetwork.fury.type.KycDataPayload")
}

func init() { proto.RegisterFile("fury/type/kyc.proto", fileDescriptor_aefa821fa9aaec33) }
